"""
Django settings for mbctv_44486 project.
...
WSGI_APPLICATION = 'mbctv_44486.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mbctv_44486 API",
    "DESCRIPTION": "API documentation for mbctv_44486 App",
    "VERSION": "v1",
}
